...
public class OnboardActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onboard_activty);
    ...
    private void showHelp() {
        ...
        toolbar.setNavigationIcon(ContextCompat.getDrawable(this, R.drawable.ic_account));

        // We load a drawable and create a location to show a tap target here
        // We need the display to get the width and height at this point in time
        final Display display = getWindowManager().getDefaultDisplay();
        // Load our little droid guy
        final Drawable droid = ContextCompat.getDrawable(this, R.drawable.ic_map_black_24dp);
        ...
        final TapTargetSequence sequence = new TapTargetSequence(this)
                ...
                .listener(new TapTargetSequence.Listener() {
                    ...
                    public void onSequenceCanceled(TapTarget lastTarget) {
                        final AlertDialog dialog = new AlertDialog.Builder(OnboardActivty.this)
                                .setTitle("Uh oh")
        ...
        TapTargetView.showFor(this, TapTarget.forView(findViewById(R.id.fab), "Hello, world!", spannedDesc)
                .cancelable(false)
                .drawShadow(true)
                .titleTextDimen(R.dimen.text_size_small)
                .tintTarget(false), new TapTargetView.Listener() {
            @Override
            public void onTargetClick(TapTargetView view) {
                super.onTargetClick(view);
