...
public class FacultyCoordinatorListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

  public TextView c_name, c_dept,c_designation, c_phone,c_email;
 public ImageView c_image;

private ItemClickListener itemClickListener;
    public FacultyCoordinatorListViewHolder(View itemView) {
        super(itemView);
