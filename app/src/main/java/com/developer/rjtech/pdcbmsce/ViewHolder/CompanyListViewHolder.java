...
public class CompanyListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
...
private ItemClickListener itemClickListener;
    public CompanyListViewHolder(View itemView) {
       ...
       // textMenuName = itemView.findViewById(R.id.menu_name);
        imageView = itemView.findViewById(R.id.company_list_image);
