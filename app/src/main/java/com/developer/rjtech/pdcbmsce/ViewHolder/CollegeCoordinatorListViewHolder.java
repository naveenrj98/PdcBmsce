...
public class CollegeCoordinatorListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

  public TextView c_name, c_designation, c_phone,c_email;
 public ImageView c_image;

private ItemClickListener itemClickListener;
    public CollegeCoordinatorListViewHolder(View itemView) {
        super(itemView);
