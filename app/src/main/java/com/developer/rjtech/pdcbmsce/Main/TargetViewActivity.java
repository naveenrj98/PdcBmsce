...
public class TargetViewActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//------------------------------------Bottom Navigation Code Starts--------------------------------------------------
        ...
        bottomNavigation.setOnReselectListener(new MeowBottomNavigation.ReselectListener() {
            ...
            public void onReselectItem(MeowBottomNavigation.Model item) {
                Toast.makeText(TargetViewActivity.this, "reselected item : " + item.getId(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        final TapTargetSequence sequence = new TapTargetSequence(this)
                .targets(
                        ...
                        TapTarget.forBounds(homedroidTarget, "Home!", "Navigation for PlacementRules/ContactCoordinators/AlumniDetails/BuildResume")
                                ...
                                .icon(home)
                                .id(1),
                        TapTarget.forBounds(newsdroidTarget, "Notification", "User can get the regular updates from the BMSCE placement department")
                                .cancelable(false)
                                .icon(news)
                                .id(2),
                        TapTarget.forBounds(codingdroidTarget, "Coding Club", "User can Practise the Coding/Aptitude and Prepare for the Interview")
                                ...
                                .icon(coding)
                                .id(3),
                        TapTarget.forBounds(companydroidTarget, "Company Details", "User can find the CompanyDetails/CTC/JobDescription ...etc")
                                .cancelable(false)
                                .icon(company)
                                .id(4),
                        TapTarget.forBounds(accountdroidTarget, "Profile Settings", "User can update the Personal information")
                                .cancelable(false)
                                .icon(account)
                                .id(5),
                        TapTarget.forToolbarOverflow(toolbar, "This will show more options", "User can Navigate to Account Settings and User can Share the App")
                                .cancelable(false)
                                .id(6)
                )
                .listener(new TapTargetSequence.Listener() {
                    ...
                    public void onSequenceFinish() {
                        Toast.makeText(getApplicationContext(), "You are ready to go! Best of Luck", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(TargetViewActivity.this, MainActivity.class);
                    ...
                    public void onSequenceCanceled(TapTarget lastTarget) {
                        final AlertDialog dialog = new AlertDialog.Builder(TargetViewActivity.this)
                                .setTitle("Uh oh")
